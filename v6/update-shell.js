(() => {
  ...
  document.documentElement.dataset.visualBuild = 'compact-commercial-20260807m';
  const style = document.createElement('style');
  style.id = 'gcr-compact-commercial-m';
  style.textContent = `
    /* Mobile-only density refinement. Functional V6 logic remains untouched. */
    @media(max-width:719px){
      ...
      /* Keep the approved premium navigation artwork visible; only reduce its footprint. */
  ...
  const refreshKey = 'gcr-compact-commercial-20260807m';
