const CACHE = 'graxcare-ready-visual-sync-20260808a';
const APP_SHELL = [
  './',
  './index.html',
  './install.html',
  './manifest-commercial.webmanifest?r=visual-sync-20260808a',
  './assets/graxcare-icon-source-20260807.svg',
  ...
  './commercial-logo.js?r=visual-sync-20260808a',
