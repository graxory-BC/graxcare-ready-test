const CACHE = 'graxcare-ready-stable-nav-hq-icon-20260807v';
const APP_SHELL = [
  './',
  './index.html',
  './install.html',
  './manifest-commercial.webmanifest?r=commercial-hq-20260807v',
  ...
  './commercial-logo.js?r=commercial-hq-20260807v',
  './update-shell.js?r=compact-commercial-20260807r',
  './assets/graxcare-icon-192.png?v=20260807v',
  './assets/graxcare-icon-512.png?v=20260807v',
