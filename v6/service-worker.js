const CACHE = 'graxcare-ready-compact-commercial-20260807m';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.webmanifest?r=compact-commercial-20260807m',
  ...
  './assets/graxcare-app-icon.svg?r=commercial-master-20260807m',
